...
public class NotificationServiceImpl implements NotificationService {
        ...
        public void sendOutOfStockAlert(String productId, String productName) {
                ...
                messagingTemplate.convertAndSend("/topic/admin-owner/notifications", notification);
                log.info("Alerta: Producto sin stock - {}", productName);
        }
        ...
        @Override
        public NotificationDTO createNotification(NotificationType type, String title, String message, String targetUrl,
                        Object data) {
