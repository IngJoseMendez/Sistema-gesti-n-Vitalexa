...
public interface OrdenRepository extends JpaRepository<Order, UUID> {
        ...
        /**
         * Obtener el número de factura más alto de todas las órdenes
         * Útil para sincronizar la secuencia después de crear facturas históricas
         */
        @Query("SELECT COALESCE(MAX(o.invoiceNumber), 0) FROM Order o")
